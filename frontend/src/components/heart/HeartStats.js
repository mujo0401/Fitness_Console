...
import { Grid, Typography, Box, Card, CardContent, Skeleton, Avatar, useTheme } from '@mui/material';
...
/**
 * StatCard component displays a metric with an icon, value, and trend information
 */
const StatCard = ({ 
  title, 
  value, 
...
/**
 * HeartStats component displays key heart rate metrics in a row of cards
 */
const HeartStats = ({ avgHR, maxHR, minHR, restingHR, currentZone }) => {
  return (
